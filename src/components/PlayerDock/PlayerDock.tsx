...
export const PlayerDock: React.FC<PlayerDockProps> = () => {
  return (
    <div className="fixed bottom-0 left-0 z-50 grid w-full h-24 grid-cols-1 px-8 bg-white md:grid-cols-3 dark:bg-gray-800 dark:border-gray-500 border-t-2">
      <div className="flex justify-center flex-col">
        <div className="ps-3 py-1 text-sm text-white truncate">Song Name</div>
        <div className="ps-3 py-1 text-gray-500 text-xs truncate">Artist</div>
      </div>
